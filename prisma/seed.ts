...
const demoServices = [
  ...
  },
  {
    ...
    category: "Masculino",
    color: "#354052",
    description: "Corte masculino com acabamento e lavagem.",
    duration: 45,
    id: "demo-service-men-cut",
  ...
  },
  {
    ...
    category: "Masculino",
    color: "#5f4b3b",
    description: "Barba desenhada com toalha quente e finalizacao.",
    duration: 30,
    id: "demo-service-beard-design",
  ...
  },
  {
    ...
    category: "Coloração",
    color: "#b86b46",
    description: "Coloracao global com preparacao e acabamento.",
    duration: 120,
    id: "demo-service-global-color",
  ...
  },
  {
    ...
    category: "Coloração",
    color: "#b989a5",
    description: "Mechas iluminadas com tonalizacao suave.",
    duration: 120,
    id: "demo-service-highlights",
  ...
  },
  {
    ...
    category: "Tratamento",
    color: "#6f7f6d",
    description: "Reconstrucao capilar com protocolo nutritivo.",
    duration: 90,
    id: "demo-service-hair-repair",
  ...
  },
  {
    ...
    category: "Outros",
    color: "#8b6f47",
    description: "Consultoria para rotina de cuidados e produtos.",
    duration: 15,
    id: "demo-service-beauty-consulting",
    name: "Consultoria de beleza",
    price: "60.00",
  },
  {
    archivedAt: new Date("2026-07-20T12:00:00.000Z"),
    category: "Outros",
    color: "#8a4545",
    description: "Servico legado mantido para testar arquivamento.",
    duration: 45,
    id: "demo-service-legacy-package",
    name: "Pacote legado",
    price: "140.00",
  },
] as const;
